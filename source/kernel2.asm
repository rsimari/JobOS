...
; ==================================================================
	...
	%DEFINE JOBOS_VER '0.1'	; OS version number
	%DEFINE JOBOS_API_VER 16	; API version for programs to check
...
option_screen:
	...
	os_init_msg		db 'Welcome to JobOS', 0
	os_version_msg		db 'Version ', JOBOS_VER, 0

	dialog_string_1		db 'Thanks for trying out JobOS!', 0
